		...
		<div id='' class="grid grid-colums-2 sm:grid-cols-3 sm:items-center rounded-md ">
            <div id='navbar-top' class='fixed justify-between items-center text-center grid grid-cols-2 w-full top-0 z-50 m-0 p-0 duration-500 text-2xs sm:text-sm lg:text-base verde h-4'>
                ...
                <div class='flex mx-auto gap-2'>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 azul" viewBox="0 0 20 20" fill="currentColor" width='1.3em' height='1.3em'>
                        <path d="M17.924 2.617a.997.997 0 00-.215-.322l-.004-.004A.997.997 0 0017 2h-4a1 1 0 100 2h1.586l-3.293 3.293a1 1 0 001.414 1.414L16 5.414V7a1 1 0 102 0V3a.997.997 0 00-.076-.383z" />
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                    </svg>
                    <p class='left'>5618350826</p>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="0.99em" height="1em" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 256 259" class='h-auto w-auto'>
                    ...
                    <a href='https://wa.me/525570072288?text=Hola quiero preguntar...' class='underline' target='_blank' class=''>
                        <p class=''>5570072288</p>
                    </a>
                </div>
